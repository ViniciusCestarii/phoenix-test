...
config :phoenix_test, PhoenixTest.Repo,
  url: System.get_env("DATABASE_URL") || "ecto://postgres:123456@phoenix_test_postgres/phoenix_test_dev",
  stacktrace: true,
...
config :phoenix_test, PhoenixTestWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "5YpNmS39172XiYOS9Ploj0afiRRZ5dWl8sZ6raWCdueHyUpU6xQi53g86kGZHixz",
  watchers: [
